...
static const char col_gray4[]         = "#000000"; /* text color on focus color */
static const char col_cyan[]          = "#FFFF00"; /* focus color */
...
/* brightness commands */
static const char *brightup[]       = { "sudo", "increase-brightness", "10000", NULL};
static const char *brightdown[]     = { "sudo", "decrease-brightness", "10000", NULL};
